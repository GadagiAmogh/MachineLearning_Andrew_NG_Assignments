...
% the training set.
% Add the bias term
% Now that we have normailzed the features
% 
% , we again add a column of ones corresponding to $\theta_0$ to the data matrix 
% |X*.*|
...
price = [1 1650 3]; % Enter your price formula here

price(2:3) = ((price(2:3)-mu)/sigma)
...
price = [1 1650 3]; % Enter your price forumla here
price(2:3) = ((price(2:3)-mu)/sigma)
